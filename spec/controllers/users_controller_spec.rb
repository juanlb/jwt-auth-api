...
RSpec.describe UsersController, type: :controller do
  ...
  let(:valid_attributes) do
    { name: 'Juan', email: 'juanlb@gmail.com' }
  end

  let(:invalid_attributes) do
    { name: nil, email: 'juanlb@gmail.com' }
  end
  ...
  describe 'GET #reset_user_key' do
    it 'changes the user key' do
      user = User.create! valid_attributes
      expect do
        get :reset_user_key, params: { id: user.to_param }, session: valid_session
      end.to change { user.reload.user_key }
    end
  end
  ...
  describe 'GET #password' do
    it 'returns a success response' do
      user = User.create! valid_attributes
      get :password, params: { id: user.to_param }, session: valid_session
      expect(response).to be_successful
    end
  end
